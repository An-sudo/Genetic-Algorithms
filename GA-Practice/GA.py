...
def main():
    ...
    al = input("Please input crossover algorithm(u=uniform,k=k-point):")
    if al == 'k':
        print("The crossover algorithm is k-point")
    elif al == 'u':
        print("The crossover algorithm is uniform")

    g_n = input("Please input the number of generation you want(Integer):")
